...
{
    /// <summary>
    /// Доменная модель персонажа с его характеристиками, способностями и модификаторами.
    /// </summary>
    public sealed class CharacterModel
    {
            ...
            IReadOnlyList<ModificationModel> modifications)
        {
            ...
            if (string.IsNullOrWhiteSpace(name))
                throw new ArgumentException("Имя персонажа не должно быть пустым.", nameof(name));
