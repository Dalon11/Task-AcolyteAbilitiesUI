...
{
    /// <summary>
    /// Bind-слой списка персонажей Party с фиксированными слотами из инспектора.
    /// </summary>
    public sealed class PartyListView : MonoBehaviour
    {
        ...
        public void Bind(IPartyViewModel viewModel, Action<string> onCharacterClick)
        {
            ...
            if (_itemViews == null)
                throw new InvalidOperationException("Не задан массив слотов PartyCharacterItemView для PartyListView.");
