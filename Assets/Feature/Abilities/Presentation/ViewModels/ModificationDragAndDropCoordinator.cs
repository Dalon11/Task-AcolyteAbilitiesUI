...
{
    /// <summary>
    /// Координирует drag-and-drop модификатора на способности.
    /// </summary>
    public sealed class ModificationDragAndDropCoordinator
    {
        ...
        private string _activeSourceAbilityId;
        ...
        public bool TryStartDragFromAbility(string abilityId)
        {
            ...
            _activeSourceAbilityId = draggedData.SourceAbilityId;
        ...
        private void ResetDragState()
        {
            ...
            _activeSourceAbilityId = string.Empty;
        }
